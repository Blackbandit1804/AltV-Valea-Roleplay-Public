    ...
    class CharactersTablet
    {
        ...
        public static string GetCharacterTabletApps(int charId)
        {
            ...
            var items = CharactersTabletApps_.Where(x => x.charId == charId).Select(x => new
            {
                ...
                lspdapp = ServerFactions.IsCharacterInAnyFaction(charId) && ServerFactions.IsCharacterInFactionDuty(charId) && (ServerFactions.GetCharacterFactionId(charId) == 1 || ServerFactions.GetCharacterFactionId(charId) == 3),
                fibapp = ServerFactions.IsCharacterInAnyFaction(charId) && ServerFactions.IsCharacterInFactionDuty(charId) && ServerFactions.GetCharacterFactionId(charId) == 3,
                ...
                justiceapp = ServerFactions.IsCharacterInAnyFaction(charId) && ServerFactions.IsCharacterInFactionDuty(charId) && ServerFactions.GetCharacterFactionId(charId) == 2,
            }).ToList();
